...
console.log("ex 3:", game.difficulty)
...
const selectedPokemon = pokemon
  .filter((p) => ["grass", "fire", "water"].includes(p.type) && p.hp > 30)
  .slice(0, 3)

game.party.push(...selectedPokemon)

console.log("ex 5:", game.party)
...
const evolvedPokemon = pokemon.find(
  (p) => p.number === game.party[starterIndex].number + 1
)
game.party.splice(starterIndex, 1, evolvedPokemon)

console.log("ex 7:", game.party)
...
*/
console.log("ex 9: ")
const starterPok = pokemon.filter((p) => p.starter)
starterPok.forEach((p) => console.log(p.name))
